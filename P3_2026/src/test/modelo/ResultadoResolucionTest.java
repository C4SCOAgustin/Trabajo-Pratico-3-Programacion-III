...
public class ResultadoResolucionTest {
	...
	@Test
	public void testResultadoErrorConservaMensajeConEspacios() {
		ResultadoResolucion resultado = ResultadoResolucion.error("  mensaje  ");
	...
	@Test
	public void testResultadoExitoNoTieneMensajeError() {
		ResultadoResolucion resultado = ResultadoResolucion.exito(equipo, estadisticas);
	...
	@Test
	public void testResultadoErrorNoTieneDatosDeExito() {
		ResultadoResolucion resultado = ResultadoResolucion.error("fallo");
	...
	@Test
	public void testResultadoExitoConEstadisticasNull() {
		ResultadoResolucion resultado = ResultadoResolucion.exito(equipo, null);

		assertTrue(resultado.esExito());
		assertSame(equipo, resultado.getEquipo());
		assertNull(resultado.getEstadisticas());
	}
}
